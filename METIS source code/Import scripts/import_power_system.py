...
useReserveModel = True
useClusterModel = True
useGradients = False
useResMustRunModel = False

"""
Specify which multiplying factor should be applied to all interconnections
NTCcorrection: double
"""
NTCcorrection = 1.0
...
execfile(Constantes.REP_SCRIPTS + "/user/scripts/execution_power_system.py")
